						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<s:iterator var="o" value="pageBean.list" status="status">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="14%"><s:property value="#o.oid" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="14%"><s:property value="#o.total" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="10%"><s:property value="#o.name" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									...
									<td align="center" style="HEIGHT: 22px"><input
										type="button" style="background-color: #EADAEB;" value="查看"
