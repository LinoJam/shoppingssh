...
<body>
	<div class="container header">
		...
		<div class="span9">
			<div class="headerAd">
				<img src="image\r___________renleipic_01/header.jpg" alt="."
					title="." height="50" width="320">
			</div>
		</div>
		...
		<div class="span18 last">
			...
			<form id="cartForm"
				...
				<div class="action">
					...
					<div class="buy">
						<!-- style//class="addCart"  -->
						<input id="addCart" value="加入购物车" type="button"
							style="background-color:#F10582; font: lighter; 12px tahoma,Arial,Verdana,sans-serif;"
							onclick="saveCart()" />
					</div>
				</div>
			</form>
