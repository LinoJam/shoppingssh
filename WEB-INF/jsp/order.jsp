...
<body>
	...
	<div class="container cart">
		<div class="span24">
			...
			<!-- 确认订单表单 -->
			<form id="orderForm"
				action="${ pageContext.request.contextPath }/order_findByUid.action?page=1"
				method="post">
				...
				<div class="span24">
					<%-- <p>
						收货地址：<input name="addr" type="text"
							value="<s:property value="model.user.addr"/>" style="width:350px" /><br />
						收货人&nbsp;&nbsp;&nbsp;：<input name="name" type="text"
							value="<s:property value="model.user.name"/>" style="width:150px" /><br />
						联系方式：<input name="phone" type="text"
					...
					<p style="text-align:right">
						...
						<a href="javascript:document.getElementById('orderForm').submit();">
							...
							<strong style="color:#F10582;">点击购买</strong>
						</a>
					</p>
				</div>
			</form>
